...
The goal of this Implementation Guide is to specify how to represent in HL7 CDA R2 the International Patient Summary (IPS) ( see also the [ART DECOR](https://art-decor.org/art-decor/decor-project--hl7ips-) repository). 
An alternative representation as HL7 FHIR is also provided ( see the [hl7.org site](https://hl7.org/fhir/uv/ips/).
